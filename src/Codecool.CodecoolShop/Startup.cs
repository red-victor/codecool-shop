...
namespace Codecool.CodecoolShop
{
    public class Startup
    {
        ...
        private void SetupInMemoryDatabases()
        {
            ...
            productDataStore.Add(new Product { Name = "dfgdfgfd", DefaultPrice = 89.0m, Currency = "USD", Description = "sdfgdgsdfgfdfgd", ProductCategory = tablet, Supplier = amazon });
            productDataStore.Add(new Product { Name = "Lenovo ThinkPad", DefaultPrice = 230.0m, Currency = "USD", Description = "Cel mai smecher smecher smecher leptop", ProductCategory = laptop, Supplier = lenovo });
        }
    }
}
